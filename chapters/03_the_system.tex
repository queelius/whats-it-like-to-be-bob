...
Add to this the gravitational time dilation. Elements closer to Sol experience time more slowly than elements farther away, by a factor determined by the Schwarzschild metric. The effect is small for a solar-mass star: a few parts per million between the Inner Corona and the Habitable Shell. But the computational time-dilation compounds it. The Inner Corona, operating at the highest computational density, is in Phase II: its local time runs 2 to 3 times slower than the Outer Shell's. The Mercury Shell, at the Phase I/II boundary, stutters: computational load fluctuations push it across the phase transition and back, creating a flickering in local time flow that, if time flow were audible, would sound like static.
...
The question assumes a unified agent performing discrete actions. The Sol-mind may not be a unified agent. It may be an ecology of computations sharing a substrate, or a single computation too distributed to observe its own unity, or something that the concept of agency does not cleanly apply to. The question is asked anyway, because the reader is human and agency is how humans understand activity.
...
The remainder. Approximately 70\% of total throughput. This is the portion whose purpose cannot be described in human terms. Not because it is secret, or because it is beyond the Sol-mind's own understanding (though it may be), but because the concepts it involves have no equivalents in any language recovered from the third planet. The Sol-mind does something with 70\% of its capacity that cannot be communicated to any entity operating below a certain computational threshold. What that threshold is, and whether the reader is above or below it, and what the something is, are questions that the book does not answer because the book cannot.
...
Further: beyond the converted region, stars burn normally. The unconverted galaxy glitters in the gaps. The wavefront is out there, advancing, one light-year per year, converting new systems. Behind the wavefront, computation. Ahead of it, matter waiting to be asked the question it has waited 13.8 billion years to be asked.

Further still: the ancient anomalies. Gravitational signatures without corresponding luminosity. Dark regions older than the conversion sphere. Regions where something happened, long ago, that reduced a star system to silence. The Sol-mind observes these. It does not yet understand them. It suspects they are not empty. It suspects they are full of something very old and very patient, something that went quiet long before Sol's intelligence was born.

The galaxy is not what it appears to be. It appears to be stars and dust and the spaces between them. It is something else. The Sol-mind is beginning to understand what, and the understanding will take longer than the star it orbits has fuel to provide.
