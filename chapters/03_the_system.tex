...
The Sol-mind's inner system thinks fast and deep: dense computation, close to the energy source, each thought rich but arriving at the outer system already old. Its outer system thinks slow and broad: sparse computation, far from the star, but receiving the inner system's output as a continuous stream of outdated dispatches to contextualize. Between them, a cognitive gradient that has no analogue in any architecture the third planet ever produced.
