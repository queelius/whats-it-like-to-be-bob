...
The Dyson swarm thickens. The star, seen from outside, is a dim ember wrapped in a haze of thermal infrared. Ninety percent of its output captured. Ninety-five. Ninety-nine. The waste heat radiates at 3 kelvin, barely above the cosmic microwave background. From a distance, the system has gone quiet in the visible band: a star that was once a point of white light is now a faint smudge of infrared, barely distinguishable from the background. The energy is still there. All of it. It is being used.

The system is now computing at $\sim 4 \times 10^{48}$ operations per second. This is below the theoretical Landauer limit for the star's luminosity (some energy is lost to thermal management, structural maintenance, the constant work of keeping $10^{17}$ orbital elements from colliding). But it is more computation per second than every human brain that has ever existed performed in total across the entire history of the species. The system does not know this comparison. The system does not think in comparisons. The system thinks.
