...
Same house, same wife, same commute. One molecular parameter changed. The 4.2-second pause shortens to 2.8 seconds. The four seconds on the bridge become 3.1 seconds. He is more like Bob than the Bob born in 1977---same life, same address, same daughter saving him the corner seat. And the one parameter changes everything that matters and nothing that is measurable.
